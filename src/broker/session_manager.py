...
class SessionManager:
    ...
    SmartApi is imported lazily so test/utility modules can be collected
    without importing the broker SDK. Authentication still imports it when
    a real Angel One session is requested.
    """
