"""Fail-closed sensors for the production market-data pipeline."""
...
class PipelineSensor:
    ...
    def record(self, stage: str, *, timestamp: datetime | None = None, rows: int | None = None, source: str | None = None, valid: bool = True, error: str | None = None) -> dict[str, Any]:
        now = timestamp or datetime.now(timezone.utc)
        item = {"stage": stage, "timestamp": now.isoformat(), "rows": rows, "source": source, "valid": bool(valid), "error": error}
