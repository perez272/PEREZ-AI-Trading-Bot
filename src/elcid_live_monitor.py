...
accounting_nav_per_share = (
    ACCOUNTING_NAV_CR * Decimal("10000000") / SHARES
)

market_vs_accounting_nav = (
    LTP / accounting_nav_per_share - Decimal("1")
) * Decimal("100")

market_vs_base_sotp = (
    LTP / BASE_VALUE_PER_SHARE - Decimal("1")
) * Decimal("100")

base_discount = (
    Decimal("1") - LTP / BASE_VALUE_PER_SHARE
) * Decimal("100")
